...
class Api:
    ...
    def __init__(self, api_usocket_full_name, *, validate=True, on_error=None):
        ...
        self.replay_mode = Resource(self, "/replay/mode")
        self.replay_save = Resource(self, "/replay/save")
        self.replay_load = Resource(self, "/replay/load")
        self.replay_reset = Resource(self, "/replay/reset")
